...
<a href="<?=base_url(akses().'/ahp/kriteria/add');?>" class="btn btn-success btn-md">Tambah Kriteria Utama</a>
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		  ...
		  echo form_open(base_url(akses().'/ahp/kriteria/updatedata'),array('class'=>'form-horizontal'));
		  ?>		  		  
        	...
        	<tbody>
        		...
        		if(!empty($arr))
        		{
					...
					<tr>
						...
						<td>
							<a href="<?=base_url(akses().'/ahp/subkriteria');?>?kriteria=<?=$kk;?>" class="btn btn-xs btn-info">Parameter</a>
							<a onclick="return confirm('Yakin ingin menghapus data ini?');" href="<?=base_url(akses().'/ahp/kriteria/deletedata');?>?id=<?=$kk;?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
						</td>
					</tr>
					<?php
					}
