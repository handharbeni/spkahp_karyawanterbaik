...
{
	function ambil_nilai_kriteria($penilaianID,$dari,$tujuan)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
...
{
	function ambil_nilai_subkriteria($penilaianID,$kriteriaid,$dari,$tujuan)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
...
{
	function ambil_prioritas($penilaianID,$subkriteriaID)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
...
if(!function_exists('get_prioritas_kriteria'))
{
	function get_prioritas_kriteria($penilaianID,$kriteriaID)
	{
		$CI=& get_instance();
		$CI->load->library('m_db');
		$s=array(
		...
		$item=$CI->m_db->get_row('temp_prioritas',$s,'prioritas');
		return $item;
	}
}
